...
|----------|-------------|---------|
| `SPARK_MCP_URL` | MCP server URL | `http://jeder-spark.local:3100` |
| `SPARK_MCP_URL_TAILSCALE` | MCP URL via Tailscale | `http://jeder-spark:3100` |
| `SPARK_HOST` | Spark hostname for SSH | `jeder-spark.local` |
| `SPARK_USER` | SSH username | `jeder` |
| `SPARK_VLLM_ENDPOINT` | vLLM API endpoint | `http://jeder-spark.local:8000` |
| `SPARK_OLLAMA_ENDPOINT` | Ollama API endpoint | `http://jeder-spark.local:11434` |
